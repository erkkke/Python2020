...
def game_over_scene(whoiam, score):
    ...
    Restart = Button('Restart', 175, 450, 150, 40, None, (0, 100, 0), (0, 176, 0), None)
    Quit = Button('Quit', 500, 450, 150, 40, None, (100, 0, 0), (176, 0, 0), None)
    ...
    while show:
        ...
        message2 = font2.render(f'Your score: {score}', 1, (255, 255, 255))
    ...
    if action == 'Restart': restart = True
    elif action == 'Quit': quit()



def multiplayer_game_start():
    global restart, screen, bullet_sound, hit_sound, whoiam, myscore
    ...
    while mainloop:
        ...
        try:
            ...
            # kicked = event_client.response['kicked'][0]
            #
            # if kicked['tankId'] == client.tank_id:
            #
            #     isKicked = True
